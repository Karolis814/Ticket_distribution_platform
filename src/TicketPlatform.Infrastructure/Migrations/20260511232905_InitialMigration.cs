        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Orders_TotalPriceCents", "\"TotalPriceCents\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    OccurenceStartDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    OccurenceEndDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    AdmissionStartDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    AdmissionEndDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TicketTypes_MaxUses", "\"MaxUses\" >= 0");
                    table.CheckConstraint("CK_TicketTypes_PriceCents", "\"PriceCents\" >= 0");
                    table.CheckConstraint("CK_TicketTypes_Quantity", "\"Quantity\" >= 1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StripeStatus = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OrderItems_UnitPriceCents", "\"UnitPriceCents\" >= 0");
                    table.ForeignKey(
